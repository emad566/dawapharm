...
<div class="container">
    ...
    <div class="panel panel-default">
        <div class="panel-heading"> كل الطلبيات
            <a href="<?php echo e(url('/')); ?>?p=customerOrder" class="btn btn-primary action-btn pull-left"><i
        ...
        <div class="panel-body panelBodyForm">
            ...
            <?php if($customers->count()<1): ?> <div id="" class="alert alert-dismissable alert-danger">
        ...
        <table id="usersTable" class="table table-hover table-striped table-bordered order-column dataTable">
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo ++$i; ?></td>
                    <td>
                        <a href="<?php echo e(url('pharm/customer/'.$customer->id.'?p=customer')); ?>">
                            <?php echo e($customer->name); ?></a>
                    </td>
                    
                    <td><?php echo e($customer->whats); ?></td>
                    <td><?php echo e(($customer->offerTotal) *.8); ?></td> <!-- Added by Ahmed Suror 10-12-2020 -->
                    ...
                    <td>
                        <!--<a href="<?php echo e(url('pharm/customer')); ?>/<?php echo e($customer->id); ?>/edit?p=customer"><i class="fas fa-edit delEdit"></i></a> Modified by Ahmed Suror 10-12-2020-->
                        ...
                        <form id='delete-form<?php echo e($customer->id); ?>' class='delete-form' method='post'
