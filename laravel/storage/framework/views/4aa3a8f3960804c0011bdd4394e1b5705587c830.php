...
<?php if(($monthNumber->is_site_active || Auth::check()) && $offerSelected): ?>
    <?php if($isShowPage): ?>
            ...
            <div class="panel-body panelBodyForm offerDiv">
                ...
                <table id="usersTable" class="table table-hover table-striped table-bordered order-column">
                    ...
                    <tbody>
                        ...
                        <tr class="pro_id<?php echo e($product->id); ?>">
                            <th >
                                <?php echo e($product->p_name); ?>

                                <input value="<?php echo e($product->id); ?>" type="hidden" name="productOfferIds[]" class="pro_id<?php echo e($product->id); ?>">
                                <?php if($product->p_active_ingredient): ?><span class="activeP"><?php echo e($product->p_active_ingredient); ?></span><?php endif; ?>
                            </th>
                            <td>
                                <input pro_id="pro_id<?php echo e($product->id); ?>" value="<?php echo e(old('offerAmount'.$product->id)); ?>" type="number" min="0" step="1" max='99999999999'
                                    name="offerAmount<?php echo e($product->id); ?>" class="form-control offerAmount pro_id<?php echo e($product->id); ?>"
                            ...
                            <th>
                                ...
                                <input type="hidden" name="offerpPrices[]" value="<?php echo e($product->id); ?>" class="pro_id<?php echo e($product->id); ?>">
                            </th>
                            <th>
                                <span id="discount<?php echo e($product->id); ?>" class='discount' value="<?php echo e($offer->discount); ?>"><?php echo e($offer->discount); ?> %</span>
                            </th>

                            <td>
                                <input  id="offerP<?php echo e($product->id); ?>" readonly="readonly" class="btnLabel offerPAmountVal pro_id<?php echo e($product->id); ?>"
                        ...
                        <tr>
                            ...
                            <td colspan="4">  يجب ان يكون الحد الأدني لمنتجات العرض بسعر الجمهور <?php echo e($offerSelected->minPrice); ?> ج.م.</td>
                        </tr>
                ...
                <div id="offerPriceAlert" class="alert alert-info">
                    ...
                    <strong>
                        عذرا القيمة الإجمالية لأصناف االعرض يجب ان تكون بحد ادني <?php echo e($offerSelected->minPrice); ?>
        ...
        <div id="productsInfo" class="panel panel-default tab expireDiv">
            ...
            <div class="panel-body panelBodyForm">
                ...
                <table id="usersTable" class="table table-hover table-striped table-bordered order-column">
                    ...
                    <?php $__currentLoopData = $offerSelected->products()->where('offer_product.is_expired', 1)->orderBy('products.p_name', 'ASC')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                        <tr class="pro_id<?php echo e($product->id); ?>">
                            <th>
                                <?php echo e($product->p_name); ?>

                                <input value="<?php echo e($product->id); ?>" type="hidden" name="product_id[]" class="pro_id<?php echo e($product->id); ?>">
                                <?php if($product->p_active_ingredient): ?><span class="activeP"><?php echo e($product->p_active_ingredient); ?></span><?php endif; ?>
                            </th>
                            <th><span id="pPrice<?php echo e($product->id); ?>" class='pPrice'
                                    value="<?php echo e($product->p_price); ?>"><?php echo e($product->p_price); ?></span></th>
                                    <input type="hidden" name="pPrices[]" value="<?php echo e($product->p_price); ?>" class="pro_id<?php echo e($product->id); ?>">
                            <td>
                                <input pro_id="pro_id<?php echo e($product->id); ?>" value="<?php echo e(old('amount'.$product->id)); ?>" type="number" min="0" step="1" max='99999999999'
                                    name="amount<?php echo e($product->id); ?>" class="form-control name amount pro_id<?php echo e($product->id); ?>"
                                    amountid="<?php echo e($product->id); ?>" id="amount<?php echo e($product->id); ?>" placeholder="الكمية *">
                            </td>
                            <td><input  id="p<?php echo e($product->id); ?>" readonly="readonly" class="btnLabel pAmountVal pro_id<?php echo e($product->id); ?>"
...
$(document).ready(function() {
    ...
    $(".offerAmount").on('keyup change', function() {
        ...
        $("#offerP" + $(this).attr('amountid')).val(parseFloat(offerpPrice * offerpAmount * (100-<?php echo e($offerSelected->discount); ?>)/100).toFixed(2))
        ...
        $("#spanOrderPrice").html(parseFloat(offerTotalAmount / ((100- <?php echo e($offerSelected->discount); ?>) /100)).toFixed(2) )
        ...
        spanExpireTotal = (( <?php echo e($offerSelected->expireTotal); ?> / <?php echo e($offerSelected->offerPrice); ?>) * offerTotalAmount).toFixed(2)
        $(".spanExpireTotal").html(spanExpireTotal)



        if (offerTotalAmount >= <?php echo e($offerSelected->minPrice); ?>) {
            $('#offerTotalTr').css({
                'background': '#0084BF'
            })
            $('#offerPriceAlert').css({
    ...
    function validateForm() {
        ...
        if(x[currentTab].getAttribute("id") == "offerInfo"){
            ...
            if(valid == false){
                ...
                alert("عذرا القيمة الإجمالية لأصناف االعرض يجب ان تكون بحد ادني <?php echo e($offerSelected->minPrice); ?> ، جنية الرجاء حاول تغيير الكميات المطلوبة بحيث توافق هذا الشرط.")
