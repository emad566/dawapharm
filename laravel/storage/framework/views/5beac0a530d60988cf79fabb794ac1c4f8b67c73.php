            ...
            <div class="col-md-6">
                <table id="usersTable" class="table table-hover table-striped table-bordered order-column"> 
                    <tbody>
                        ...
                        <tr>
                            <th width="250px" offerID="<?php echo e($customer->offer->id); ?>"> العرض </th>                    
                        ...
                        <tr>
                            ...
                            <td><?php echo e($customer->offer->charge + $offerPrice); ?></td>
                        </tr>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body panelBodyForm">
                <table id="usersTable" class="table table-hover table-striped table-bordered order-column"> 
                    ...
                    <tbody>
                        <?php $__currentLoopData = $customer->products()->where("type", "offer")->orderBy('sort_factor', 'asc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <th>
                        ...
                        <tr id="" class="">
                            ...
                            <td><?php echo e($customer->offerTotal); ?></td>
                        </tr>
                    </tbody>
                </table>
        </div><!-- .panel-body  -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body panelBodyForm">
                <table id="usersTable" class="table table-hover table-striped table-bordered order-column"> 
                    ...
                    <tbody>
                        <?php $__currentLoopData = $customer->products()->where("type", "expired")->orderBy('sort_factor', 'asc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <th>
                                <?php echo e($product->p_name); ?>
