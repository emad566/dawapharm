...
<div class="container" style="margin-bottom:150px">
    ...
    <form id='regForm' class='regForm form-horizontal panelForm' method='POST'
                ...
                <table id="usersTable" class="table table-hover table-striped table-bordered order-column">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($offerSelected->offerPrice); ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($offerSelected->charge + $offerSelected->offerPrice); ?></td>
                        </tr>

                        <tr>
                            <th>سعر الاكسبير المستبدل</th>
                            <td><?php echo e($offerSelected->expireTotal); ?></td>
                        </tr>
        ...
        <div id="productsInfo" class="panel panel-default tab">
            <div class="panel-heading">
                 حدد كميات أصناف الإستبدال التي تريد طلبها
            </div>
            ...
            <div class="panel-body panelBodyForm">
                ...
                <table id="usersTable" class="table table-hover table-striped table-bordered order-column">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $offer->products()->orderBy('sort_factor', 'asc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input value="<?php echo e(old('amount'.$product->id)); ?>" type="number" min="0" max='99999999999'
        ...
        <div id="priceAlert" class="alert alert-dismissable alert-danger">
            ...
            <strong>
                عذرا القيمة الإجمالية لأصناف الاستبدال يجب ان تكون في حدود مبلغ <?php echo e($offerSelected->expireTotal); ?>
...
$(document).ready(function() {
    ...
    $(".amount").on('keyup change', function() {
        ...
        maxprice =<?php echo e($offerSelected->expireTotal); ?> + <?php echo e($offerSelected->tolerance); ?>

        minprice =<?php echo e($offerSelected->expireTotal); ?> - <?php echo e($offerSelected->tolerance); ?>
    ...
    function validateForm() {
        ...
        if(x[currentTab].getAttribute("id") == "productsInfo"){
            valid = isvalid
            if(valid == false){
                $('#totalTr').css({
                    'background': 'red'
                ...
                alert("عذرا القيمة الإجمالية لأصناف الاستبدال يجب ان تكون في حدود مبلغ <?php echo e($offerSelected->expireTotal); ?> ، جنية الرجاء حاول تغيير الكميات المطلوبة بحيث توافق هذا الشرط.")
