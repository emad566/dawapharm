...
<div class="container">
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <button id="submitFormCreate" type="submit" form="CreateUser" class="savebtn btn btn-primary">حفظ التعديلات </button>
        ...
        <div class="panel-body panelBodyForm">
            ...
            <form id='CreateUser' class='CreateUser form-horizontal panelForm' method='POST' action="<?php echo e(route('offer.update', [$offer->id])); ?>" enctype="multipart/form-data">
                ...
                <div class="form-group<?php echo e($errors->has('discount') ? ' has-error' : ''); ?>">
                    ...
                    <input value="<?php if(old('discount')): ?><?php else: ?><?php echo e($offer->discount); ?><?php endif; ?>" type="number" step="0.01" min="0" max='99999999999' required name="discount" class="form-control name" id="discount" placeholder="نسبة ربح الصيدلية *">
                ...
                <div class="form-group<?php echo e($errors->has('offerPrice') ? ' has-error' : ''); ?>">
                    ...
                    <input readonly value="<?php if(old('offerPrice')): ?><?php else: ?><?php echo e($offer->offerPrice); ?><?php endif; ?>" type="number" step="0.01" min="0" max='99999999999' required name="offerPrice" class="form-control name" id="offerPrice" placeholder="سعر العرض *">
                ...
                <div class="form-group<?php echo e($errors->has('minPrice') ? ' has-error' : ''); ?> col-md-4">
                    ...
                    <input value="<?php if(old('minPrice')): ?><?php else: ?><?php echo e($offer->minPrice); ?><?php endif; ?>" type="number" step="0.01" min="0" max='99999999999' required name="minPrice" class="form-control name" id="minPrice" placeholder="سعر الحد الأدني - صيدلي *">
                ...
                <div class="form-group<?php echo e($errors->has('minPriceOrder') ? ' has-error' : ''); ?> col-md-4">
                    ...
                    <input value="<?php if(old('minPriceOrder')): ?><?php else: ?><?php echo e($offer->minPriceOrder); ?><?php endif; ?>" type="number" step="0.01" min="0" max='99999999999' required name="minPriceOrder" class="form-control name" id="minPriceOrder" placeholder="سعر الحد الأدني - جمهور *">
                ...
                <div class="form-group<?php echo e($errors->has('minPrice') ? ' has-error' : ''); ?> col-md-4">
                    ...
                    <input value="<?php if(old('minPricePrecent')): ?><?php else: ?><?php echo e($offer->minPricePrecent); ?><?php endif; ?>" type="number" step="0.01" min="0" max='99999999999' required name="minPricePrecent" class="form-control name" id="minPricePrecent" placeholder=" نسبة الحد الأدني من سعر العرض *">
                ...
                <div class="panel panel-default">
                    ...
                    </div><!-- .panel-body  -->                    <div class="panel-body panelBodyForm">
                            ...
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input style="display: none !important;" type="checkbox" value="<?php echo e($product->id); ?>" <?php echo e($checked); ?> name="products[]" id="product<?php echo e($product->id); ?>">
                                    </td>
                                    <td>
                                        <input type="checkbox" proId="<?php echo e($product->id); ?>" name="is_offer<?php echo e($product->id); ?>" id="is_offer<?php echo e($product->id); ?>" class="proType is_offer" <?php echo e($is_offer_checked); ?>>
                                    </td>
                                    <td>
                                        <input type="number" name="offerPriority<?php echo e($product->id); ?>" placeholder="الترتيب" class="priorityInput" value="<?php echo e($offerPriority); ?>">
                                    </td>

                                    <td>
                                        <input type="checkbox" proid="<?php echo e($product->id); ?>" name="is_expired<?php echo e($product->id); ?>" id="is_expired<?php echo e($product->id); ?>" class="proType is_expired" <?php echo e($is_expired_checked); ?>>
                                    </td>
                                    <td>
                                        <input type="number" name="expiredPriority<?php echo e($product->id); ?>" placeholder="الترتيب" class="priorityInput" value="<?php echo e($expiredPriority); ?>">
                                    </td>
...
<script>
    $(document).ready(function(){
        ...
        $(document).on("keyup",'#discount', function(e) {
            offerPriceVal = ($('#orderPrice').val() - ($('#orderPrice').val() * $('#discount').val() /100)).toFixed(2)
