    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body panelBodyForm">
            ...
            <form id='CreateUser' class='CreateUser form-horizontal panelForm' method='POST' action="<?php echo e(route('currentmonth.update', [1])); ?>">
                ...
                <div class="form-group<?php echo e($errors->has('is_site_active') ? ' has-error' : ''); ?>">
                    <label for="is_site_active">
                        ...
                        class=" is_site_active" id="is_site_active"
                        <?php if($currentmonth->is_site_active): ?> checked="checked" <?php endif; ?>
                        >

                        تفعيل الموقع
                    </label>

                    <?php if($errors->has('is_site_active')): ?>
                        <span class="help-block">
                            <strong><?php echo e($errors->first('is_site_active')); ?></strong>
                        </span>
                    <?php endif; ?>
                </div>
