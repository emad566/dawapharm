    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body panelBodyForm">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body panelBodyForm">
                    <ul style="list-style: none;">
                        <?php $__currentLoopData = $offer->products()->where('offer_product.is_expired', 1)->orderBy('products.p_name', 'ASC')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <label for="product<?php echo e($product->id); ?>">
                                    <a target="_blank" href="<?php echo e(url('pharm/product/'. $product->id . '?p=product' )); ?>"><i class="fas fa-coffe attachIcon"></i><?php echo e($product->p_name); ?></a>
                                </label>
