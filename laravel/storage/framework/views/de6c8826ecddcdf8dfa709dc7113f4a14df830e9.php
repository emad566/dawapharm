...
<div class="container">
    <div class="panel panel-default">
        <div class="panel-heading">
            <a href="<?php echo e(url('pharm/offer?p=offer')); ?>" class="btn btn-primary newRecored pull-left"><i
        ...
        <div class="panel-body panelBodyForm">
            ...
            <form id='CreateUser' class='CreateUser form-horizontal panelForm' method='POST'
                action="<?php echo e(route('offer.store', [])); ?>" enctype="multipart/form-data">
                ...
                <div class="form-group<?php echo e($errors->has('offerName') ? ' has-error' : ''); ?>">
                    ...
                    <input value="<?php echo e(old('offerName')); ?>" type="text" name="offerName" required
                ...
                <div class="form-group<?php echo e($errors->has('desc') ? ' has-error' : ''); ?>">
                    ...
                    <textarea name="desc" id="desc" class="form-control desc editor"
                        placeholder="وصف العرض"><?php echo e(old('desc')); ?></textarea>
                ...
                <div class="form-group<?php echo e($errors->has('orderPrice') ? ' has-error' : ''); ?>">
                    ...
                    <input value="<?php echo e(old('orderPrice')); ?>" type="number" step="0.01" min="0" max='99999999999' required
                ...
                <div class="form-group<?php echo e($errors->has('discount') ? ' has-error' : ''); ?>">
                    ...
                    <input value="<?php echo e(old('discount')); ?>" type="number" step="0.01" min="0" max='99999999999' required
                ...
                <div class="form-group<?php echo e($errors->has('offerPrice') ? ' has-error' : ''); ?>">
                    ...
                    <input readonly value="<?php echo e(old('offerPrice')); ?>" type="number" step="0.01" min="0" max='99999999999'
                ...
                <div class="form-group<?php echo e($errors->has('minPrice') ? ' has-error' : ''); ?> col-md-4">
                    ...
                    <input value="<?php echo e(old('minPrice')); ?>" type="number" step="0.01" min="0" max='99999999999' required
                ...
                <div class="form-group<?php echo e($errors->has('minPriceOrder') ? ' has-error' : ''); ?> col-md-4">
                    ...
                    <input value="<?php echo e(old('minPriceOrder')); ?>" type="number" step="0.01" min="0" max='99999999999'
                ...
                <div class="form-group<?php echo e($errors->has('minPrice') ? ' has-error' : ''); ?> col-md-4">
                    ...
                    <input value="<?php echo e(old('minPricePrecent')); ?>" type="number" step="0.01" min="0" max='99999999999'
                ...
                <div class="form-group<?php echo e($errors->has('expireTotal') ? ' has-error' : ''); ?>">
                    ...
                    <input value="<?php echo e(old('expireTotal')); ?>" type="number" step="0.01" min="0" max='99999999999' required
                ...
                <div class="form-group<?php echo e($errors->has('charge') ? ' has-error' : ''); ?>">
                    ...
                    <input value="<?php echo e(old('charge')); ?>" type="number" step="0.01" min="0" max='99999999999' required
                ...
                <div class="form-group<?php echo e($errors->has('tolerance') ? ' has-error' : ''); ?>">
                    ...
                    <input value="<?php echo e(old('tolerance')); ?>" type="number" step="0.01" min="0" max='99999999999' required
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input style="display: none !important" type="checkbox"
                                            value="<?php echo e($product->id); ?>" name="products[]" id="product<?php echo e($product->id); ?>">
                                    </td>
                                    <td>
