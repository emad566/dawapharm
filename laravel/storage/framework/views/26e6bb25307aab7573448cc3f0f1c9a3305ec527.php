...
<div class="container">
    <div class="panel panel-default">
        <div class="panel-heading"><a href="<?php echo e(url('pharm/product?p=product')); ?>"
        ...
        <div class="panel-body panelBodyForm">
            ...
            <form id='CreateUser' class='CreateUser form-horizontal panelForm' method='POST'
                ...
                <div class="form-group<?php echo e($errors->has('p_name') ? ' has-error' : ''); ?>">
                    ...
                    <input value="<?php echo e(old('p_name')); ?>" type="text" name="p_name" required class="form-control name"
                ...
                <div class="form-group<?php echo e($errors->has('p_active_ingredient') ? ' has-error' : ''); ?>">
                    ...
                    <input value="<?php echo e(old('p_active_ingredient')); ?>" type="text" name="p_active_ingredient"
                ...
                <div class="form-group<?php echo e($errors->has('p_price') ? ' has-error' : ''); ?>">
                    ...
                    <input value="<?php echo e(old('p_price')); ?>" type="number" step="0.01" min="0" max='99999999999' required
                ...
                <!-- <div class="form-group<?php echo e($errors->has('sort_factor') ? ' has-error' : ''); ?>">
                    ...
                    <input value="<?php echo e(old('sort_factor')); ?>" type="number" step="0.01" min="0" max='99999999999' required
                        ...
                        <ul style="list-style: none;">
                            ...
                            <li>
                                <label for="offer<?php echo e($offer->id); ?>">
                                    <input type="checkbox" value="<?php echo e($offer->id); ?>" name="offers[]"
                                        id="offer<?php echo e($offer->id); ?>">
                                    <a target="_blank" href="<?php echo e(url('pharm/offer/'. $offer->id . '?p=offer' )); ?>"><i
                                            class="fas fa-coffe attachIcon"></i><?php echo e($offer->offerName); ?></a>
                                </label>
                            </li>
